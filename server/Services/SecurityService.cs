...
namespace Clear.Risk
{
    public class SecurityService
    {
        ...
        public SecurityService(ClearConnectionContext context,
        ...
        public ClearConnectionContext context { get; set; }
        ...
        {
            return Principal.Identity.IsAuthenticated; //UveousAppContext.Current.User.Identity.IsAuthenticated;
                                                       //
        }
        ...
        {
            return Principal.Identity.GetUserOrgId();
        }
        public int getCountryId()
        {
            return Principal.Identity.GetCountryId();
        }
