...
{
    public partial class AddSwmsTemplatestepComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            swmstemplatestep = new Clear.Risk.Models.ClearConnection.SwmsTemplatestep(){};
        }

        protected async System.Threading.Tasks.Task Form0Submit(Clear.Risk.Models.ClearConnection.SwmsTemplatestep args)
        {
            swmstemplatestep.SWMSID = int.Parse($"{SWMSID}");

            try
            {
                var clearConnectionCreateSwmsTemplatestepResult = await ClearConnection.CreateSwmsTemplatestep(swmstemplatestep);
