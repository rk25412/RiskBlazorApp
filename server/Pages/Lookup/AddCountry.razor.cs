...
{
    public partial class AddCountry: ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Country args)
        {
            try
            {
                var clearRiskCreateCountryResult = await ClearRisk.CreateCountry(country);
                DialogService.Close(country);
            }
            catch (System.Exception clearRiskCreateCountryException)
            {
