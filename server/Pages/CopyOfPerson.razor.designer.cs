...
{
    public partial class CopyOfPersonComponent : ComponentBase
    {
        ...
        {
            var dialogResult = await DialogService.OpenAsync<EditPerson>("Edit Person", new Dictionary<string, object>() { {"PERSON_ID", args.PERSON_ID} });
            await InvokeAsync(() => { StateHasChanged(); });
        }
        ...
        protected async System.Threading.Tasks.Task GridDeleteButtonClick(MouseEventArgs args, dynamic data)
        {
            try
            {
                ...
                {
                    var clearConnectionDeletePersonResult = await ClearConnection.DeletePerson(data.PERSON_ID);
